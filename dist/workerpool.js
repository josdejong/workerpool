...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports.isMainThread = module.exports.platform === 'browser' ? typeof Window !== 'undefined' : !node.require('process').connected;
...
/***/ function(module, exports, __webpack_require__) {
	...
	function WorkerHandler(script) {
	  ...
	  // send all queued request to worker
	  function dispatchQueuedRequests()
	  {
	    me.request_queue = me.request_queue.filter(me.worker.send.bind(me.worker));
	  }
