 ...
 * @property {boolean} [emitStdout] Emit stdout from worker under the `stdout` event. Not supported by `web` worker type.
 * @property {boolean} [emitStderr] Emit stderr from worker under the `stderr` event. Not supported by `web` worker type.
